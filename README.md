...
- Prefer **Upload file** on the live Render demo — YouTube downloads are often blocked on cloud IPs.  
...
- Use a short recording (under 1–2 minutes) for the first demo to avoid timeouts.
